...
<qgis version="2.2.0-Valmiera" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="Smoothed Rate" symbollevels="0" type="graduatedSymbol">
    <ranges>
      <range symbol="0" lower="0.000000" upper="0.000104" label="0.0000 - 0.0001"/>
      <range symbol="1" lower="0.000104" upper="0.016233" label="0.0001 - 0.0162"/>
      <range symbol="2" lower="0.016233" upper="0.197936" label="0.0162 - 0.1979"/>
      <range symbol="3" lower="0.197936" upper="1.101556" label="0.1979 - 1.1016"/>
      <range symbol="4" lower="1.101556" upper="40.829900" label="1.1016 - 40.8299"/>
    </ranges>
    <symbols>
      ...
      <symbol alpha="1" type="marker" name="1">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="219,219,235,255"/>
          <prop k="color_border" v="0,0,0,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="rectangle"/>
          <prop k="offset" v="0,0"/>
      ...
      <symbol alpha="1" type="marker" name="2">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="162,159,203,255"/>
          <prop k="color_border" v="0,0,0,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="rectangle"/>
          <prop k="offset" v="0,0"/>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="0" name="Observed Count"/>
    <edittype labelontop="0" editable="1" type="0" name="Smoothed Rate"/>
    <edittype labelontop="0" editable="1" type="0" name="b-value"/>
  </edittypes>
  <editform></editform>
